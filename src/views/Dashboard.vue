...
<p class='mx-3 sidehead'>Account Overview</p>
  ...
  <p class='mx-3'>{{ customer.first_name }} {{ customer.last_name }}</p>

<p class='ml-3 addd'> {{ customer.email }} </p>
...
<p class='mx-3 addd'>{{ customer.first_name }} {{ customer.last_name }}
<br>
...
{{ customer.phone }}</p>
 ...
 <b-row>
    ...
    <div class="d-flex flex-sm-row d-lg-flex flex-lg-row flex-wrap">
      <div class="mr-auto"  v-for="product in allProduct" :key="product.product_id">
